...
import (
	...
	extendedclient "github.com/dalibo/cnpg-i-logical-backup/internal/instance/client"
...
// Start starts the sidecar informers and logical-backup plugin
// server. This is the part running on the sidecar container.
func Start(ctx context.Context) error {
	setupLog := log.FromContext(ctx)
	setupLog.Info("Starting logical-backup instance plugin")
	...
	if err := mgr.Add(&LogicalBackupPluginServer{
